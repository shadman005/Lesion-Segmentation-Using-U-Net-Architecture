...
for i=1:1:210
fileName = strcat('malignant (',num2str(i),').png');   
I = imread(fileName); 
fileName = strcat('malignant (',num2str(i),')_pred.png');   
...
patient{i} = cellstr(strcat('M_',num2str(i)));
target_variable{i} = 1;
...
filename = 'feature_set_malignant.xlsx';
